...
% Author placeholder - Update with actual author info if needed
\author{\IEEEauthorblockN{Chen Zhenxing}
\IEEEauthorblockA{\textit{Changsha University of Science and Technology} \\
Changsha, China \\
Email: [1006503012@qq.com]}
}
...
\begin{IEEEkeywords}
Network Measurement, Steady Flows, Sketch Algorithms, Bloom Filter, Traffic Analysis.
\end{IEEEkeywords}
...
\caption{The framework of the SF-Detector. It consists of a Filter part and a Record part.}
\label{fig:framework}
\end{figure}
...
\bibitem{b1} Xiong B, Liu Y, Liu R, et al. ActiveGuardian: An accurate and efficient algorithm for identifying active elephant flows in network traffic[J]. Journal of Network and Computer Applications, 2024, 224: 103853.
\bibitem{b2} Xiong B, Chang Y, Zhang Y, et al. AF-Detector: An accurate low-overhead method for detecting active flows in network traffic[J]. Computer Networks, 2025: 111562.
\bibitem{b3} Xiong B, et al. RobustSketch: Robust Identification of Heavy Flows Supporting Traffic Jitter[J]. Journal of Software, 2024, 36(2): 660-679.
\bibitem{b4} Roy P, Khan A, Alonso G. Augmented sketch: Faster and more accurate stream processing[C]//Proceedings of the 2016 International Conference on Management of Data. ACM, 2016: 1449-1463.
\bibitem{b5} Yang T, Jiang J, Liu P, et al. Elastic sketch: Adaptive and fast network-wide measurements[C]//Proceedings of the 2018 Conference of the ACM Special Interest Group on Data Communication. ACM, 2018: 561-575.
\bibitem{b6} Zhou Y, Yang T, Jiang J, et al. Cold filter: A meta-framework for faster and more accurate stream processing[C]//Proceedings of the 2018 International Conference on Management of Data. ACM, 2018: 741-756.
\bibitem{b7} Xiao Q, Zhou Y, Chen S. Better with fewer bits: Improving the performance of cardinality estimation of large data streams[C]//IEEE INFOCOM 2017-IEEE Conference on Computer Communications. IEEE, 2017: 1-9.
\bibitem{b8} Tang L, Huang Q, Lee P P C. MV-Sketch: A fast and compact invertible sketch for heavy flow detection in network data streams[C]//IEEE INFOCOM 2019. IEEE, 2019: 2026-2034.
\bibitem{b9} Yang T, Zhang H, Li J, et al. HeavyKeeper: an accurate algorithm for finding Top-k elephant flows[J]. IEEE/ACM Transactions on Networking, 2019, 27(5): 1845-1858.
\bibitem{b10} Epicoco I, Melle C, Cafaro M, et al. UDDSketch: Accurate tracking of quantiles in data streams[J]. IEEE Access, 2020, 8: 147604-147617.
\bibitem{b11} Gu Y, McCallum A, Towsley D. Detecting anomalies in network traffic using maximum entropy estimation[C]//Proceedings of the 5th ACM SIGCOMM Conference on Internet Measurement. ACM, 2005: 32-32.
\bibitem{b12} Gou X, He L, Zhang Y, et al. Sliding sketches: A framework using time zones for data stream processing in sliding windows[C]//Proceedings of the 26th ACM SIGKDD International Conference on Knowledge Discovery \& Data Mining. ACM, 2020: 1015-1025.
\bibitem{b13} Liu Z, Kong C, Yang K, et al. HyperCalm Sketch: One-pass mining periodic batches in data streams[C]//2023 IEEE 39th International Conference on Data Engineering. IEEE, 2023: 14-26.
\bibitem{b14} Li X, Fan Z, Li H, et al. SteadySketch: Finding steady flows in data streams[C]//2023 IEEE/ACM 31st International Symposium on Quality of Service. IEEE, 2023: 1-9.
\bibitem{b15} Zhong Z, Yan S, Li Z, et al. BurstSketch: Finding bursts in data streams[C]//Proceedings of the 2021 International Conference on Management of Data. ACM, 2021: 2375-2383.
\bibitem{b16} Fan Z, Hu Z, Wu Y, et al. PISketch: Finding persistent and infrequent flows[C]//Proceedings of the ACM SIGCOMM Workshop on Formal Foundations and Security of Programmable Network Infrastructures. ACM, 2022: 8-14.
\bibitem{b17} Bloom B H. Space/time trade-offs in hash coding with allowable errors[J]. Communications of the ACM, 1970, 13(7): 422-426.
\bibitem{b18} Luo L, Guo D, Ma R T B, et al. Optimizing Bloom filter: Challenges, solutions, and comparisons[J]. IEEE Communications Surveys \& Tutorials, 2018, 21(2): 1912-1949.
\bibitem{b19} Zhang Y, Li J, Lei Y, et al. On-Off Sketch: A fast and accurate sketch on persistence[J]. Proceedings of the VLDB Endowment, 2020, 14(2): 128-140.
\bibitem{b20} Cormode G, Muthukrishnan S. An improved data stream summary: the count-min sketch and its applications[J]. Journal of Algorithms, 2005, 55(1): 58-75.
\bibitem{b21} Charikar M, Chen K, Farach-Colton M. Finding frequent items in data streams[C]//Proceedings of the 29th International Colloquium on Automata, Languages and Programming. Springer, 2002: 693-703.
\bibitem{b22} Yuan Z, Miao J, Jia Y, et al. Counting data stream based on improved counting Bloom filter[C]//2008 The Ninth International Conference on Web-Age Information Management. IEEE, 2008: 512-519.
\bibitem{b23} The CAIDA UCSD Anonymized Internet Traces[EB/OL]. https://www.caida.org/catalog/datasets/passive\_dataset.
\bibitem{b24} MAWI Working Group Traffic Archive[EB/OL]. https://mawi.wide.ad.jp/mawi/.
